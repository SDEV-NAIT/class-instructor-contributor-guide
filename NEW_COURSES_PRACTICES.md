...
- One Primary Course Repository (with the following files and directories.)
  - **assignments/**
    - One folder for each assignment
  ...
  - **One folder for each topic/module taught in the course.**
  ...
  - **README.md** for the course
    ...
    - Personal Resources from Instructors
      - Should have an instructor name
        - Under the instructor name include links and notes that the instructor found useful.
